                    ...
                    <div class="row margin-top-30">
                        <div class="col-md-3">
                          <div class="footer-item footer-widget-one">
                              <img alt="" src="img/logo-black.png" class="footer-logo">
                              <p>Voluptate porro esse repellat quo exercitationem debitis incidunt.</p>

                              <ul class="address">
                                <li><i class="fa fa-phone"></i>Phone: 021-090078601</li>
                                <li><i class="fa fa-envelope"></i><a href="mailto:">Email: contact@medicative.com</a></li>
                              </ul>
                        ...
                        <div class="col-md-3">
                          <div class="footer-item">
                            ...
                            <ul class="footer-list border-deshed color-icon">
                              ...
                              <li><i class="fa fa-angle-right"></i><a href="Department.php">Department</a></li>
                              <li><i class="fa fa-angle-right"></i><a href="doctors.php">Doctors</a></li>
                              <li><i class="fa fa-angle-right"></i><a href="blogs.php">Blog</a></li>
                        ...
                        <div class="col-md-3">
                          <div class="footer-item">
                            ...
                            <ul class="footer-list border-deshed color-icon">
                              <li><i class="fa fa-angle-right"></i><a href="#">Transplants</a></li>
                              <li><i class="fa fa-angle-right"></i><a href="#">Gastroenterology</a></li>
                              <li><i class="fa fa-angle-right"></i><a href="#">Orthopaedics</a></li>
                              <li><i class="fa fa-angle-right"></i><a href="#">Spine Care</a></li>
                              <li><i class="fa fa-angle-right"></i><a href="#">Cancer Care</a></li>
                            </ul>
                          </div>
                        </div>
                        <div class="col-md-3">
