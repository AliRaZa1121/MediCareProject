...
$query = $pdo->query("SELECT doctors.*,specialities.name as SpecName, cities.name as CityName  from doctors
                      ...
                      Join cities on cities.id = doctors.cityid ORDER BY RAND() LIMIT 3");
    ...
    <div class="container">
        ...
        <div class="section-content">
            <div class="row">
                ...
                <?php
               $query = $pdo->query("SELECT * FROM `news` ORDER BY `news`.`PublishedOn` DESC LIMIT 3");
               $rows = $query->fetchAll(PDO::FETCH_ASSOC);
               foreach ($rows as $row) {?>  
                <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="blog-item style-1">
                            ...
                            <div class="blog-img"><a href="#"><img style="height: 225px; width: 370px;" src="../uploading/<?php echo $row['NewsCover'] ?>" alt=""></a>
                            ...
                            <div class="blog-content">
                                ...
                                <i class="fa fa-user-o"></i> <a href="#">Author:  <?php echo $row['Author'] ?></a> <br> 
                                <i class="fa fa-calendar"></i> <a href="#">Published On :  <?php echo $row['PublishedOn'] ?></a>
                                <p><?php echo $row['Title'] ?>.</p>
                                <a href="blogdetails.php?blogid=<?php echo $row['Id'] ?>" class="btn btn-simple">Read More</a>
                            </div>
                        </div>
                    </div>
               <?php }
